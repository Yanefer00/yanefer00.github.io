...
if(document.calcform.input.value.length<=1){
	...
	document.calcform.netAmount.value="Â£"+roundVal(input);
	document.calcform.VAT.value="Â£"+roundVal(vat);
	document.calcform.gross.value="Â£"+roundVal(gross);
	document.calcform.basedOn.value="Â£"+roundVal(input);
...
if(document.calcform.input.value.length<=1){
	...
	document.calcform.netAmount.value="Â£"+roundVal(net);
	document.calcform.VAT.value="Â£"+roundVal(vat);
	document.calcform.gross.value="Â£"+roundVal(input);
	document.calcform.basedOn.value="Â£"+roundVal(input);
...
function clearCalc(){
	document.calcform.input.value="Â£";
}
